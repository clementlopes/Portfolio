  ...
  <div class="navbar top-0 fixed bg-base-100 px-4 shadow-lg z-10">
    <div class="navbar-start">
      ...
      <div class="dropdown">
        ...
        <ul
          tabindex="0"
          class="w-52 menu menu-md dropdown-content mt-3 p-2 bg-base-100 rounded-box shadow"
        >
      ...
      <NuxtLink to="/" class="font-bold text-xl hover:scale-105 transition duration-500"
        >Clément Lopes</NuxtLink
      >
    </div>
