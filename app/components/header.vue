    ...
    <div class="navbar-end">
      ...
      <div v-if="userData" class="dropdown dropdown-end">
        ...
        <ul tabindex="-1" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow">
          ...
          <li>
            <NuxtLink class="justify-between" to="/profilePage"> Perfil <svg xmlns="http://www.w3.org/2000/svg"
          ...
          <li @click="handleLogout()"><a class="justify-between" href="/">Logout <svg class="size-6"
