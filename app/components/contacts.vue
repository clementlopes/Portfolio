                ...
                <a href="https://www.github.com/clementlopes" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" fill="currentColor"
                    ...
                    <path data-name="layer2"
                          ...
                          fill="bg-primary"></path>

                  </svg>
                </a>
                <a class="px-4" href="https://www.github.com/clementlopes" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" fill="currentColor"
                       stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                       class="size-10 text-primary">
                    <path data-name="layer1"
                          fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10"
